...
pub struct FrameworkConfig {
    /// Directory to watch (relative to project root)
    pub root: Option<String>,
    /// Output CSS file to write (relative to project root)
...
pub struct DxStylesConfig {
    /// Selected framework profile (e.g. "nextjs", "vite", "react", "html")
    pub framework: Option<String>,
    /// Map of framework name -> config
